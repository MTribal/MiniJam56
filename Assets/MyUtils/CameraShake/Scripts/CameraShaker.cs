...
namespace My_Utils.CameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        public CameraShakeInstance ShakeOnce(ShakeSettings cameraShakeSettings)
        {
            CameraShakeInstance shake = new CameraShakeInstance(cameraShakeSettings.Magnitude, cameraShakeSettings.Roughness,
                                                                cameraShakeSettings.fadeInDuration, cameraShakeSettings.fadeOutDuration);
